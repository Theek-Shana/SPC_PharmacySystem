...
public class ReplyTendersModel : PageModel
{

    private readonly ILogger<ReplyTendersModel> _logger;
    ...
    public ReplyTendersModel(ILogger<ReplyTendersModel> logger, IHttpClientFactory httpClientFactory)
    {
        _logger = logger;
